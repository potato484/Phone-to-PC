export const DOM = {
  ...
  viewTerminalBtn: document.getElementById('view-terminal-btn'),
  viewDesktopBtn: document.getElementById('view-desktop-btn'),
  desktopWrap: document.getElementById('desktop-wrap'),
  desktopSurface: document.getElementById('desktop-surface'),
  desktopCanvas: document.getElementById('desktop-canvas'),
  desktopPlaceholder: document.getElementById('desktop-placeholder'),
  desktopStatusText: document.getElementById('desktop-status-text'),
  desktopConnectBtn: document.getElementById('desktop-connect-btn'),
  desktopCredentialsModal: document.getElementById('desktop-credentials-modal'),
  desktopCredentialsForm: document.getElementById('desktop-credentials-form'),
  desktopCredentialsHint: document.getElementById('desktop-credentials-hint'),
  desktopCredentialsUsernameRow: document.getElementById('desktop-credentials-username-row'),
  desktopCredentialsPasswordRow: document.getElementById('desktop-credentials-password-row'),
  desktopCredentialsTargetRow: document.getElementById('desktop-credentials-target-row'),
  desktopCredentialsUsername: document.getElementById('desktop-credentials-username'),
  ...
  desktopModCtrlBtn: document.getElementById('desktop-mod-ctrl'),
  desktopModAltBtn: document.getElementById('desktop-mod-alt'),
  desktopModMetaBtn: document.getElementById('desktop-mod-meta'),
  desktopCadBtn: document.getElementById('desktop-cad-btn'),
